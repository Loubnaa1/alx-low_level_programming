...
/**
 * handle_magic - function printing the magic numbers of an ELF header.
...
/**
 * handle_class - function printing the class of an ELF header.
 * @e_ident: A pointer to an array.
 */
void handle_class(unsigned char *e_ident)
{
...
/**
 * handle_data - function printing the data of an ELF header.
 * @e_ident: A pointer to an array.
 */
void handle_data(unsigned char *e_ident)
{
...
/**
 * handle_version - function printing the version of an ELF header.
 * @e_ident: A pointer to an array.
 */
void handle_version(unsigned char *e_ident)
{
...
/**
 * handle_osabi - function printing the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array.
 */
void handle_osabi(unsigned char *e_ident)
{
...
/**
 * handle_abi - function printing the ABI version of an ELF header.
 * @e_ident: A pointer to an array.
 */
void handle_abi(unsigned char *e_ident)
{
...
/**
 * handle_entry - function printing the entry point of an ELF header.
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	result = read(file_dir, header, sizeof(Elf64_Ehdr));
	if (result == -1)
	{
		free(header);
		close_elf(file_dir);
