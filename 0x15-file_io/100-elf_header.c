...
/**
 * handle_Data - function prints data of an ELF header.
 * @e_ident: A pointer to an array.
 */
void handle_Data(unsigned char *e_ident)
{
...
/**
 * handle_Version - function prints version of an ELF header.
 * @e_ident: A pointer to an array.
 */
void handle_Version(unsigned char *e_ident)
{
...
/**
 * print_OSABI - printing OS/ABI of an ELF header.
...
/**
 *handle_ABI - printing the ABI version of an ELF header.
 * @e_ident: A pointer to an array.
 */
void handle_ABI(unsigned char *e_ident)
{
...
/**
 * handle_Type - printing the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array.
 */
void handle_Type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * handle_Entry - printing the entry point of an ELF header.
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	result = read(file_descriptor, header, sizeof(Elf64_Ehdr));
	if (result == -1)
	{
		free(header);
		close_elf(file_descriptor);
